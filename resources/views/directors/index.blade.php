...
<head>
    ...
    <title>کارگردان ها - رسانه اینترنتی دارک مووی</title>
    ...
    <div class="carousel-inner">
        @foreach($billboards as $billboard)
            <div class="carousel-item {{$loop->first ? 'active' : ''}}">
                <img class="d-block w-100" src="{{asset($billboard->movie->background)}}" alt="Second slide">
...
<div id="directors" class="basic-2">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
